...
public static class SetupTimedCropSystem
{
    ...
    private static readonly CropSpec[] Crops =
    {
        ...
        new CropSpec { key = "Banana", displayName = "Banana", firstSeconds = 180f, regrowthSeconds = 0f, maximumHarvests = 1, harvestYield = 3, regrowthStageStart = 0, perennialTree = true, growthSpriteOrder = new[] { 4, 5, 6, 7, 0, 1, 2, 3 }, growthSheet = "Assets/Sprites/cây trồng/cây lâu năm/banana/bananatree_200.png", seedSprite = "Assets/Sprites/cây trồng/hạt giống/banana.png", productSprite = "Assets/Sprites/cây trồng/cây lâu năm/banana/banana_200.png" },
